...
def bitunpack():
    ...
    if len(instrdict) == 7120: # FIXME do this dynamically, need more test cases
        ...
        prefixes = [0x0, 0x40, 0x100, 0x600, 0x1000, 0x2800, 0x6000, 0x70000] # when dictlen = 7120+512
        lengths = [0x07, 0x09, 0x0a, 0x0c, 0x0d, 0x0e, 0x0f, 0x13] # when dictlen = 7120+512, range 4 = 0x0a
    else: # FIXME
